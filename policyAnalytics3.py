...
introLabel = Label(middle_pane, background="#ffffff", foreground="#76090c", font=("Franklin Gothic Heavy", 14), wraplength=root.winfo.width(), justify="center", text = "Welcome to Policy Analytics 1.0")
